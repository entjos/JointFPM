...
The next step is to fir a joint flexible parametric model using the stacked dataset.
...
Based on the model we can predict the mean number of events at different time points and covariate patterns.
